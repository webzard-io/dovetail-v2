...
// Stable reference for non-namespace-scoped resources to prevent
// unnecessary re-renders and pagination reset in ResourceList.
const EMPTY_NS_FILTER: { value: string[] } = { value: [] };
